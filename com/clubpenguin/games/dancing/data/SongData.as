...
if(!_global.com.clubpenguin.games.dancing.data.SongData)
{
   ...
   getExpertSongData = function($millisPerBeat, $songLength)
   {
   ...
   addNote = function($beatTime, $maxBeatLength, $lastNoteTimes, $millisPerBeat, $noteTypes, $noteTimes, $noteLengths)
   {
